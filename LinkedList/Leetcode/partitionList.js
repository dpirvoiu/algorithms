// Create two separate linked lists, one for values smaller than x and the other with higher
// Prev1 and Prev2 will be used to append values to the linked lists
class Node {
  constructor(value) {
    this.value = value;
    this.next = null;
